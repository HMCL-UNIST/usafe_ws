...
#include <v2x_simulation/testConfig.h>
...
dynamic_reconfigure::Server<v2x_simulation::testConfig> srv;
dynamic_reconfigure::Server<v2x_simulation::testConfig>::CallbackType f;
 
std::vector<v2x_msgs::Mission2data> mission_waypoints;
...
public:
V2xSimulation(const ros::NodeHandle& nh, const ros::NodeHandle& nh_p);
~V2xSimulation();
