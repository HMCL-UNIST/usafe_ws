...
#include <highspeed_lowlevel_ctrl/testConfig.h>
...
dynamic_reconfigure::Server<highspeed_lowlevel_ctrl::testConfig> srv;
dynamic_reconfigure::Server<highspeed_lowlevel_ctrl::testConfig>::CallbackType f;
...
// void dyn_callback(highspeed_lowlevel_ctrl::testConfig& config, uint32_t level);
