...
if("TRUE" STREQUAL "TRUE")
  set(mrt_cmake_modules_SOURCE_PREFIX /home/hmcl/traffic_sim_ws/src/mrt_cmake_modules)
  set(mrt_cmake_modules_DEVEL_PREFIX /home/hmcl/traffic_sim_ws/devel)
  ...
  set(mrt_cmake_modules_INSTALL_PREFIX /home/hmcl/traffic_sim_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://wiki.ros.org/mrt_cmake_modules " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Kevin Rösch <kevin.roesch@kit.edu>, Fabian Poggenhans <fabian.poggenhans@partner.kit.edu>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mrt_cmake_modules' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hmcl/traffic_sim_ws/src/mrt_cmake_modules/${idir}'.  ${_report}")
    endif()
