...
class MobileyeInfo_referencepoints {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MobileyeInfo_referencepoints(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MobileyeInfo_referencepoints(null);
...
module.exports = MobileyeInfo_referencepoints;
