...
"""autogenerated by genpy from mobileye_msgs/ExtLogData.msg. Do not edit."""
import codecs
import sys
...
class ExtLogData(genpy.Message):
  _md5sum = "bd5a83cb9f73511e0698020e5d37d36e"
  _type = "mobileye_msgs/ExtLogData"
...
"""
  __slots__ = ['header','lane','obstacle_status','obstacle_data']
  _slot_types = ['std_msgs/Header','mobileye_msgs/Lane','mobileye_msgs/ObstacleStatus','mobileye_msgs/ObstacleData[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,lane,obstacle_status,obstacle_data
    ...
    """
    if args or kwds:
      super(ExtLogData, self).__init__(*args, **kwds)
