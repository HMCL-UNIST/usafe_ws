...
"""autogenerated by genpy from mobileye_msgs/MobileyeInfo_seeq.msg. Do not edit."""
import codecs
import sys
...
class MobileyeInfo_seeq(genpy.Message):
  _md5sum = "44adbcbb0282c17f8d689edcb40bf0ce"
  _type = "mobileye_msgs/MobileyeInfo_seeq"
...
uint8 mest_version_patch_number"""
  __slots__ = ['header','seeq']
  _slot_types = ['std_msgs/Header','mobileye_msgs/SeeQ']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MobileyeInfo_seeq, self).__init__(*args, **kwds)
