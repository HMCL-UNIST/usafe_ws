...
class Waypoint(genpy.Message):
  _md5sum = "9f868e0a633289761bc8ebafeec1a195"
...
float64 y
float64 z"""
  __slots__ = ['gid','lid','pose','twist','lane_id']
  _slot_types = ['int32','int32','geometry_msgs/PoseStamped','geometry_msgs/TwistStamped','uint32']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_6dI().pack(_x.twist.twist.linear.x, _x.twist.twist.linear.y, _x.twist.twist.linear.z, _x.twist.twist.angular.x, _x.twist.twist.angular.y, _x.twist.twist.angular.z, _x.lane_id))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.twist.twist.linear.x, _x.twist.twist.linear.y, _x.twist.twist.linear.z, _x.twist.twist.angular.x, _x.twist.twist.angular.y, _x.twist.twist.angular.z, _x.lane_id,) = _get_struct_6dI().unpack(str[start:end])
      return self
