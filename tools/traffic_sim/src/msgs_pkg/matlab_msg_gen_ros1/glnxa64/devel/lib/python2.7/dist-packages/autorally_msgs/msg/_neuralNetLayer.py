...
"""autogenerated by genpy from autorally_msgs/neuralNetLayer.msg. Do not edit."""
import sys
...
class neuralNetLayer(genpy.Message):
  _md5sum = "5c7ae79f2ee4ffbb5044508aa41abced"
  _type = "autorally_msgs/neuralNetLayer"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """string name
float32[] weight
float32[] bias"""
  __slots__ = ['name','weight','bias']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(neuralNetLayer, self).__init__(*args, **kwds)
