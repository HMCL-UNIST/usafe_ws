    ...
    nh_(nh), nh_local_(nh_local)
{
    ...
    pub_mission1 = nh_.advertise<hmcl_v2x::HMCL_Mission1>("Mission1", 10);
    pub_mission2 = nh_.advertise<hmcl_v2x::HMCL_Mission2>("Mission2", 10);
    pub_item = nh_.advertise<hmcl_v2x::Item>("Item", 10);
    pub_request = nh_.advertise<hmcl_v2x::Request>("Request", 10);
...
{
    hmcl_v2x::HMCL_Mission1 mission;
    ...
    for(int i=0; i<msg->mission_route_count; i++)
    {
        ...
        {
            hmcl_v2x::HMCL_Mission1data data;
...
{
    hmcl_v2x::HMCL_Mission2 mission;
    ...
    {
        hmcl_v2x::HMCL_Mission2data data;
