...
private:
  ...
  std_msgs::Header camera_header_;
  ...
  ultralytics_ros::YoloResultConstPtr yolo_result_msg_;
  bool has_camera_info_, has_lidar_, has_yolo_, tf_received_ = false;
  geometry_msgs::TransformStamped transform_, inverse_;
...
public:
  ...
  void yoloCallback(const ultralytics_ros::YoloResultConstPtr& yolo_result_msg);
  void checkAndRunSyncCallback();
