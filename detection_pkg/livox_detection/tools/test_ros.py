...
class ros_demo():
    def __init__(self, model, args=None):
        ...
        # self.point_cloud_range = [0, -12.8, -2, 224, 12.8, 4]
        self.point_cloud_range = [0, -12.8, -2, 115.2, 12.8, 4]
...
if __name__ == '__main__':
    ...
    #    "/livox/lidar", PointCloud2, queue_size=3, callback=demo_ros.online_inference)
    # sub = rospy.Subscriber(
