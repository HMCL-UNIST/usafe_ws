...
from custom_msg_pkg.msg import MobileyeInfo_right

class mobileyeSub():
    def __init__(self):
        rospy.init_node("right_lane_node")
        self.mobPub = rospy.Publisher('/right_lane_Info', MobileyeInfo_right, queue_size=20)
        self.frame_ok = 0
        self.mobmsg = MobileyeInfo_right()
