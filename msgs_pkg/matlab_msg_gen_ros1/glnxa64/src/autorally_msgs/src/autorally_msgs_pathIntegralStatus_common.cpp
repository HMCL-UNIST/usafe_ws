...
// Common copy functions for autorally_msgs/pathIntegralStatus
...
namespace pathIntegralStatus {
  ...
  MDArray_T get_arr_std_msgs_Header(MDFactory_T& factory, const autorally_msgs::pathIntegralStatus::_header_type& val);
  ...
  //----------------------------------------------------------------------------
  AUTORALLY_MSGS_EXPORT void copy_from_arr(boost::shared_ptr<autorally_msgs::pathIntegralStatus>& msg, const matlab::data::StructArray arr) {
    try {
        //header
    ...
    try {
        //info
        const matlab::data::CharArray info_arr = arr[0]["info"];
  ...
  //----------------------------------------------------------------------------
  AUTORALLY_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const boost::shared_ptr<const autorally_msgs::pathIntegralStatus>& msg) {
    auto outArray = factory.createStructArray({1,1},{"header","info","status"});
    // header
    outArray[0]["header"] = get_arr_std_msgs_Header(factory, msg->header);
    // info
    outArray[0]["info"] = factory.createCharArray(msg->info);
    // status
