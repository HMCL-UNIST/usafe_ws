...
// Common copy functions of server for hmcl_msgs/RecognizeLightStateResponse
...
namespace RecognizeLightState_Response {
  //----------------------------------------------------------------------------
  HMCL_MSGS_EXPORT void copy_from_arr(hmcl_msgs::RecognizeLightState::Response& msg, const matlab::data::StructArray arr) {
    try {
        //class_id
  ...
  //----------------------------------------------------------------------------
  HMCL_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const hmcl_msgs::RecognizeLightState::Response& msg) {
