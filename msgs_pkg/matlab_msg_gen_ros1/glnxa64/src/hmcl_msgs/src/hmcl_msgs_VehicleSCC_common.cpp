...
namespace VehicleSCC {
  ...
  MDArray_T get_arr_std_msgs_Header(MDFactory_T& factory, const hmcl_msgs::VehicleSCC::_header_type& val);
  ...
  HMCL_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const boost::shared_ptr<const hmcl_msgs::VehicleSCC>& msg) {
    auto outArray = factory.createStructArray({1,1},{"header","scc_mode","scc_takeover","acceleration"});
    // header
