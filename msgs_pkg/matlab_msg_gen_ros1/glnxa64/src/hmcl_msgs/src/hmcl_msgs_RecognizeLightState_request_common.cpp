...
namespace RecognizeLightState_Request {
  ...
  MDArray_T get_arr_sensor_msgs_Image(MDFactory_T& factory, const hmcl_msgs::RecognizeLightState::Request::_roi_image_type& val);
  ...
  //----------------------------------------------------------------------------
  HMCL_MSGS_EXPORT void copy_from_arr(hmcl_msgs::RecognizeLightState::Request& msg, const matlab::data::StructArray arr) {
    try {
        //roi_image
  ...
  //----------------------------------------------------------------------------
  HMCL_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const hmcl_msgs::RecognizeLightState::Request& msg) {
