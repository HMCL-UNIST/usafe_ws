...
// Common copy functions for autoware_msgs/AdjustXY
...
namespace AdjustXY {
  ...
  MDArray_T get_arr_std_msgs_Header(MDFactory_T& factory, const autoware_msgs::AdjustXY::_header_type& val);
  ...
  //----------------------------------------------------------------------------
  AUTOWARE_MSGS_EXPORT void copy_from_arr(boost::shared_ptr<autoware_msgs::AdjustXY>& msg, const matlab::data::StructArray arr) {
    try {
        //header
  ...
  //----------------------------------------------------------------------------
  AUTOWARE_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const boost::shared_ptr<const autoware_msgs::AdjustXY>& msg) {
    auto outArray = factory.createStructArray({1,1},{"header","x","y"});
    // header
