...
int main(int argc, char *argv[])
{
  ...
  private_nh.getParam("input_topic_name", input_topic_name_);
  ...
  // NEED TO MAKE TF AS EIGEN MATRIX4F
  ...
  ros::Subscriber points_sub = nh.subscribe(input_topic_name_, 1000, points_callback);
