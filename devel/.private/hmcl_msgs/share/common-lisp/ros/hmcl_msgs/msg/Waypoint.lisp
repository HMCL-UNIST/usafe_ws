...
(cl:defmethod Junction-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hmcl_msgs-msg:Junction-val is deprecated.  Use hmcl_msgs-msg:Junction instead.")
  (Junction m))

(cl:ensure-generic-function 'Crosswalk-val :lambda-list '(m))
(cl:defmethod Crosswalk-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hmcl_msgs-msg:Crosswalk-val is deprecated.  Use hmcl_msgs-msg:Crosswalk instead.")
  (Crosswalk m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Waypoint>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'Junction) 1 0)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'Crosswalk) 1 0)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'Stop_line) 1 0)) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Waypoint>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'twist) istream)
    ...
    (cl:setf (cl:slot-value msg 'Junction) (cl:not (cl:zerop (cl:read-byte istream))))
    (cl:setf (cl:slot-value msg 'Crosswalk) (cl:not (cl:zerop (cl:read-byte istream))))
    (cl:setf (cl:slot-value msg 'Stop_line) (cl:not (cl:zerop (cl:read-byte istream))))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Waypoint>)))
  ...
  "29822e649d55c164f971af3df4646407")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Waypoint)))
  "Returns md5sum for a message object of type 'Waypoint"
  "29822e649d55c164f971af3df4646407")
