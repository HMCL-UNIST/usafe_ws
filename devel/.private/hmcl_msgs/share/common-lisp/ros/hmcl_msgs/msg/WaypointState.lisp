...
(cl:defmethod cl:initialize-instance :after ((m <WaypointState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WaypointState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hmcl_msgs-msg:<WaypointState> is deprecated: use hmcl_msgs-msg:WaypointState instead.")))

(cl:ensure-generic-function 'aid-val :lambda-list '(m))
(cl:defmethod aid-val ((m <WaypointState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hmcl_msgs-msg:aid-val is deprecated.  Use hmcl_msgs-msg:aid instead.")
  (aid m))

(cl:ensure-generic-function 'lanechange_state-val :lambda-list '(m))
(cl:defmethod lanechange_state-val ((m <WaypointState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hmcl_msgs-msg:lanechange_state-val is deprecated.  Use hmcl_msgs-msg:lanechange_state instead.")
  (lanechange_state m))

(cl:ensure-generic-function 'steering_state-val :lambda-list '(m))
(cl:defmethod steering_state-val ((m <WaypointState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hmcl_msgs-msg:steering_state-val is deprecated.  Use hmcl_msgs-msg:steering_state instead.")
  (steering_state m))

(cl:ensure-generic-function 'accel_state-val :lambda-list '(m))
(cl:defmethod accel_state-val ((m <WaypointState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hmcl_msgs-msg:accel_state-val is deprecated.  Use hmcl_msgs-msg:accel_state instead.")
  (accel_state m))

(cl:ensure-generic-function 'stop_state-val :lambda-list '(m))
(cl:defmethod stop_state-val ((m <WaypointState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hmcl_msgs-msg:stop_state-val is deprecated.  Use hmcl_msgs-msg:stop_state instead.")
  (stop_state m))

(cl:ensure-generic-function 'event_state-val :lambda-list '(m))
(cl:defmethod event_state-val ((m <WaypointState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hmcl_msgs-msg:event_state-val is deprecated.  Use hmcl_msgs-msg:event_state instead.")
  (event_state m))
