...
class Waypointhmcl {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Waypointhmcl(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new Waypointhmcl(null);
