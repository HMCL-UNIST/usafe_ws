...
class Waypoint {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.bool(obj.Junction, buffer, bufferOffset);
    ...
    bufferOffset = _serializer.bool(obj.Stop_line, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.Junction = _deserializer.bool(buffer, bufferOffset);
    ...
    data.Stop_line = _deserializer.bool(buffer, bufferOffset);
    return data;
  }
