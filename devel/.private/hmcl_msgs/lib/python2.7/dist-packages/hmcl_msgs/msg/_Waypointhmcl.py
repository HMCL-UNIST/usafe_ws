...
"""autogenerated by genpy from hmcl_msgs/Waypointhmcl.msg. Do not edit."""
import codecs
import sys
...
class Waypointhmcl(genpy.Message):
  _md5sum = "f980f8144ba8190e8db52ab486d506e2"
  _type = "hmcl_msgs/Waypointhmcl"
...
"""
  ...
  _slot_types = ['int32','int32','geometry_msgs/PoseStamped','geometry_msgs/TwistStamped','hmcl_msgs/DTLane','int32','hmcl_msgs/WaypointState','uint32','uint32','uint32','uint32','float32','float32','uint32']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Waypointhmcl, self).__init__(*args, **kwds)
      ...
      if self.dtlane is None:
        self.dtlane = hmcl_msgs.msg.DTLane()
      if self.change_flag is None:
        self.change_flag = 0
      if self.wpstate is None:
        self.wpstate = hmcl_msgs.msg.WaypointState()
