...
"""autogenerated by genpy from hmcl_msgs/Waypoint.msg. Do not edit."""
import codecs
import sys
...
class Waypoint(genpy.Message):
  _md5sum = "29822e649d55c164f971af3df4646407"
  _type = "hmcl_msgs/Waypoint"
...
float64 y
float64 z"""
  __slots__ = ['gid','lid','pose','twist','lane_id','Junction','Crosswalk','Stop_line']
  _slot_types = ['int32','int32','geometry_msgs/PoseStamped','geometry_msgs/TwistStamped','uint32','bool','bool','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       gid,lid,pose,twist,lane_id,Junction,Crosswalk,Stop_line
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_6dI3B().pack(_x.twist.twist.linear.x, _x.twist.twist.linear.y, _x.twist.twist.linear.z, _x.twist.twist.angular.x, _x.twist.twist.angular.y, _x.twist.twist.angular.z, _x.lane_id, _x.Junction, _x.Crosswalk, _x.Stop_line))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.twist.twist.linear.x, _x.twist.twist.linear.y, _x.twist.twist.linear.z, _x.twist.twist.angular.x, _x.twist.twist.angular.y, _x.twist.twist.angular.z, _x.lane_id, _x.Junction, _x.Crosswalk, _x.Stop_line,) = _get_struct_6dI3B().unpack(str[start:end])
      self.Junction = bool(self.Junction)
      self.Crosswalk = bool(self.Crosswalk)
      self.Stop_line = bool(self.Stop_line)
      return self
...
def _get_struct_2i3I():
    ...
    return _struct_2i3I
_struct_6dI3B = None
def _get_struct_6dI3B():
    global _struct_6dI3B
    if _struct_6dI3B is None:
        _struct_6dI3B = struct.Struct("<6dI3B")
    return _struct_6dI3B
_struct_7d3I = None
