...
lanelet::ArcCoordinates get_ArcCoordinate(const lanelet::ConstLineString3d centerline,geometry_msgs::Pose waypoints_pose){
    double x_tmp = waypoints_pose.position.x;
    double y_tmp = waypoints_pose.position.y;
