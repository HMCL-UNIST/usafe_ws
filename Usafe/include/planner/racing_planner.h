...
planner::Waypoint gen_avoidanceWp(lanelet::ConstLanelet lanelet_,geometry_msgs::Pose& bad_wp_pose);
std::vector<Waypoint> AddAvoidanceWaypoint(const Waypoint& bad_wp);
