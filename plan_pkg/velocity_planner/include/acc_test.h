...
class ACC 
{
    ...
    private:
    ros::NodeHandle nh_;
    ros::Publisher vel_pub, vel_debug;
    ros::Subscriber pose_sub, acc_sub, predicted_objects_sub, wheel_sub;
    ...
    double acc_cmd, d_safe, d_time, runtime;

    double DesiredVel, DesiredDis, Dis, LeadVehicleDist, rel_vel;
