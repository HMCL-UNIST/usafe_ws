...
private:
    ...
    ros::Subscriber v2x_spat_sub, pose_sub, wheel_sub, acc_sub, predicted_objects_sub, start_end_sub, mission_sub, subtype_sub,
                    traffic_sign_sub, behavior_state_sub, behavior_state_condition_sub, local_traj_sub, velocity_sub,imu_sub,sub_canAcc_sub;
    ...
    double object_x, object_y, object_vel,current_steer;
    double velocity_steer;
    ...
    bool stop = false;
    double LeadVehicleVel, LeadVehicleDist;
    double wait_tt;
    double lOpt;
    ...
    double rel_vel;
    bool stop_flag, slow_flag, acc_flag, obsavoid_flag, freedrive_flag, slowDown_flag,firstlap_flag;
    bool getMission = false, getBF = false, getPose =false;
