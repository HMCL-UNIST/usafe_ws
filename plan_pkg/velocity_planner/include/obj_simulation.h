...
#include <velocity_planner/test_simConfig.h>
...
bool sim_pose_reset;
bool lane_avail;
dynamic_reconfigure::Server<velocity_planner::test_simConfig> srv;
dynamic_reconfigure::Server<velocity_planner::test_simConfig>::CallbackType f;
...
void dyn_callback(velocity_planner::test_simConfig& config, uint32_t level);
