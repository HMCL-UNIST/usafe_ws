...

{
    switch (v)
    {
        ...
        case MissionState::MissionSlowOn: return "MissionSlowOn";
        case MissionState::MissionStop: return "MissionStop";
...
class MissionStateMachine
{
    private:
        ros::NodeHandle nh_;
        ros::Subscriber cam_health_sub, behavior_sub, pose_sub, vel_sub, signal_sub, map_ver_sub, mission_state_sub, subtype_sub ;
        ...
        bool statusWait, statusStart, statusPitStop, checkPitStop, startAfterPitStop, checkMapChangePoint, checkLap2, checkLap3, checkLap4, checkLap5, missionEnd, slowOnFlag, slowOffFlag, stopFlag, startAgain;


        //callback data
        double runRate, distToGoal, thresGoal, distToPitStop, thresPitStop, thresMapChangePoint, distToMapChangePoint;
        int countMissionInit, countVehicleReady, countPitStop, countStartFromPitStop, countLap1, countLap2, countLap3, countLap4, countLap5, countMissionComplete, countSlowOn, countStop;
    ...
    public:
        ...
        void camHealthCallback(const std_msgs::Int8MultiArray::ConstPtr& msg);
